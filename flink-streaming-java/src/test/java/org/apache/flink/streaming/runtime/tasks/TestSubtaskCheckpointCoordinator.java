...
public class TestSubtaskCheckpointCoordinator implements SubtaskCheckpointCoordinator {
	...
	@Override
	public void checkpointState(CheckpointMetaData checkpointMetaData, CheckpointOptions checkpointOptions, CheckpointMetrics checkpointMetrics,
		OperatorChain<?, ?> operatorChain, Supplier<Boolean> isCanceled) {
	}

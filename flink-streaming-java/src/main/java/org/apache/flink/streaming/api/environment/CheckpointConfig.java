...
public class CheckpointConfig implements java.io.Serializable {
	...
	public void configure(ReadableConfig configuration) {
		...
		// TODO_MA 注释： execution.checkpointing.interval = 无默认值
		...
		// TODO_MA 注释： execution.checkpointing.min-pause = Duration.ZERO
		...
		// TODO_MA 注释： execution.checkpointing.tolerable-failed-checkpoints = 无默认值
		...
		// TODO_MA 注释： execution.checkpointing.externalized-checkpoint-retention = 无默认值

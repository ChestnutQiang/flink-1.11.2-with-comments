...
public enum ShuffleMode {
	 ...
	 * // TODO_MA 注释： 生产者和消费者同时在线。 产生的数据将立即被消费者接收。
	 * // TODO_MA 注释： 流式处理
	 */
	PIPELINED,
	 ...
	 * // TODO_MA 注释： 生产者首先产生其全部结果并完成。 之后，使用者将启动并可以使用数据。
	 * // TODO_MA 注释： 批处理
	 */
	BATCH,
	 ...
	 * // TODO_MA 注释： shuffle mode 未定义。它留给框架来决定随机播放模式。
	 * // TODO_MA 注释： 框架最后将选择{@link ShuffleMode＃BATCH}或{@link ShuffleMode＃PIPELINED}中的一个。
	 * // TODO_MA 注释： 如果没决定，则由Flink框架自行决定使用 Batch 或者 Pipline
	 */
	UNDEFINED
}

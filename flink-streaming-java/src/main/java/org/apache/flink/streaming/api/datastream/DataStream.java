...
/**
 * // TODO_MA 注释： DataStream表示相同类型的元素流。
 * // TODO_MA 注释： 通过应用转换，可以将一个DataStream转换为另一个DataStream
...
public class DataStream<T> {
	...
	public DataStreamSink<T> addSink(SinkFunction<T> sinkFunction) {
		...
		// TODO_MA 注释： SinkOperator 会被封装成 StreamSink
		// TODO_MA 注释： Function Operator Transformation 可以认为是用于不同地方的同一个概念。

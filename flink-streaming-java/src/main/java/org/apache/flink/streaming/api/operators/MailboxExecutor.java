...
public interface MailboxExecutor {
	 ...
	 */
	default @Nonnull
	Future<Void> submit(@Nonnull RunnableWithException command, String descriptionFormat, Object... descriptionArgs) {
	 ...
	 */
	default @Nonnull
	Future<Void> submit(@Nonnull RunnableWithException command, String description) {
		FutureTaskWithException<Void> future = new FutureTaskWithException<>(command);
	 ...
	 */
	default @Nonnull
	<T> Future<T> submit(@Nonnull Callable<T> command, String descriptionFormat, Object... descriptionArgs) {
	 ...
	 */
	default @Nonnull
	<T> Future<T> submit(@Nonnull Callable<T> command, String description) {
		FutureTaskWithException<T> future = new FutureTaskWithException<>(command);
		execute(future, description, EMPTY_ARGS);
		return future;
	}

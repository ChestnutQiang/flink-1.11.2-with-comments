...
/**
 * // TODO_MA 注释： 可执行文件绑定到链中的特定运算符，因此可以为下游邮箱选择该可执行文件。
...
public class Mail {
	...
	/**
	 * // TODO_MA 注释： 邮件的优先级。优先级不决定顺序，但有助于隐藏来自下游处理器的上游邮件，以避免活动/死锁。
	...
	public Mail(ThrowingRunnable<? extends Exception> runnable, int priority, StreamTaskActionExecutor actionExecutor, String descriptionFormat,

...
/**
 * // TODO_MA 注释： 表示流式程序中的运算符及其所有属性的类。
 * Class representing the operators in the streaming programs, with all their properties.
 *
 * // TODO_MA 注释： 用来代表 operator 的类，并具有所有相关的属性，如并发度、入边和出边等
 */
@Internal
public class StreamNode implements Serializable {
	...
	// TODO_MA 注释： StreamNode 的 ID
	private final int id;

	// TODO_MA 注释： StreamNode 的并行度
	 ...
	 * 
	 *  注释： 对应到的 Task 执行启动类
	 *  1、如果是 Source， 则对应到： SourceStreamTask
	 *  2、如果不是 Source， 则对应到： OneInputStreamTask
	 */
	...
	/*************************************************
	 * 
	 *  注释： StreamNode 对应到一个 Operator，
	 *  一个 Operator 对应到一个 Transformation
	 *  一个 Transformation 对应到一个 Function
	 */
	...
	public void addOutEdge(StreamEdge outEdge) {
		if(outEdge.getSourceId() != getId()) {
			...
			// TODO_MA 注释： 将该 StreamEdge 加入到该 StreamNode 的 outEdges 集合中

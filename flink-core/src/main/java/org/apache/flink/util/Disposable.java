...
/**
 * // TODO_MA 注释： 可以处理的类的接口，即具有专用的生命周期步骤以“销毁”对象的类。启用的原因例如是释放本机资源。
 * // TODO_MA 注释： 从这一点来看，该接口实现了与{@link java.io.Closeable}接口类似的目的，
 * // TODO_MA 注释： 但是有时两者都应表示为独立的，独立的生命周期步骤。
...
public interface Disposable {
	...
	/**
	 * // TODO_MA 注释： 处置对象并释放所有资源。调用此方法后，在对象上调用任何方法都可能导致未定义的行为。

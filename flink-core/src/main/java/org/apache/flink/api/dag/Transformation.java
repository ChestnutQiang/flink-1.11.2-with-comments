 ...
 *
 * // TODO_MA 注释： {@code Transformation} 不一定与运行时的物理操作相对应。 某些操作仅是逻辑概念。
 * // TODO_MA 注释： 例如 union， split/select 数据流，partitioning。
 ...
 * }</pre>
 *
 * // TODO_MA 注释： 有关分区，并集，拆分/选择的信息最终被编码在将源连接到地图操作的 edges 中。
 ...
 *
 * // TODO_MA 注释： T 是该 Transformation 的输出类型
 *

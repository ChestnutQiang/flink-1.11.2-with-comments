 ...
 *
 * // TODO_MA 注释： 此接口包含用于向托管存储注册键控状态的方法。
 * This interface contains methods for registering keyed state with a managed store.
 *
 * // TODO_MA 注释： KeyedStateStore 定义了用于创建和管理托管 keyed state 的方法，
 * // TODO_MA 注释： 分别对应 ValueState，ListState，ReducingState，AggregatingState 和 MapState
 */
@PublicEvolving

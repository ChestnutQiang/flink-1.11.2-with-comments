...
public class EmbeddedExecutorFactory implements PipelineExecutorFactory {
	 ...
	 */
	public EmbeddedExecutorFactory(final Collection<JobID> submittedJobIds, final DispatcherGateway dispatcherGateway,
	...
	public PipelineExecutor getExecutor(final Configuration configuration) {
		...
		return new EmbeddedExecutor(submittedJobIds, dispatcherGateway, jobId -> {

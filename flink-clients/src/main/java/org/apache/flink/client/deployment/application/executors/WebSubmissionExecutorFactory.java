...
public class WebSubmissionExecutorFactory implements PipelineExecutorFactory {
	 ...
	 */
	public WebSubmissionExecutorFactory(final Collection<JobID> submittedJobIds, final DispatcherGateway dispatcherGateway) {
	...
	public PipelineExecutor getExecutor(final Configuration configuration) {
		...
		return new EmbeddedExecutor(submittedJobIds, dispatcherGateway, WebSubmissionJobClient::new);
	}
}

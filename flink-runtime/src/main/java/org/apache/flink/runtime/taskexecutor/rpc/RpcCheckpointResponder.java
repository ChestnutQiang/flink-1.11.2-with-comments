...
public class RpcCheckpointResponder implements CheckpointResponder {
	...
	@Override
	public void acknowledgeCheckpoint(JobID jobID, ExecutionAttemptID executionAttemptID, long checkpointId, CheckpointMetrics checkpointMetrics,
	...
	public void declineCheckpoint(JobID jobID, ExecutionAttemptID executionAttemptID, long checkpointId, Throwable cause) {
		...
		/*************************************************
		 *
		 *  注释： 发送取消 checkpoint 的消息给 JobMaster(checkpointCoordinator)
		 */
		checkpointCoordinatorGateway.declineCheckpoint(new DeclineCheckpoint(jobID, executionAttemptID, checkpointId, cause));
	}
}

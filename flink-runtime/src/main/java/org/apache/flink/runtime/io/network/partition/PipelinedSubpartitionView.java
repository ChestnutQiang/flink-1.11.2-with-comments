...
public class PipelinedSubpartitionView implements ResultSubpartitionView {
	...
	public void notifyDataAvailable() {
		 ...
		 *
		 *  注释：
		 *  availabilityListener = LocalInputChannel
		 */
	...
	public String toString() {
		return String
			.format("PipelinedSubpartitionView(index: %d) of ResultPartition %s", parent.getSubPartitionIndex(), parent.parent.getPartitionId());
	}

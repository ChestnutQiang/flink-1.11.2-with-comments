...
public class ConfigurationParserUtils {
	...
	public static int getSlot(Configuration configuration) {
		...
		ConfigurationParserUtils
			.checkConfigParameter(slots >= 1, slots, TaskManagerOptions.NUM_TASK_SLOTS.key(), "Number of task slots must be at least one.");
	 ...
	 */
	public static void checkConfigParameter(boolean condition, Object parameter, String name,

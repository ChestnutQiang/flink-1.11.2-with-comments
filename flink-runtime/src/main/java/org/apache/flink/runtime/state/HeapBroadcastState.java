...
public class HeapBroadcastState<K, V> implements BackendWritableBroadcastState<K, V> {
	...
	public String toString() {
		return "HeapBroadcastState{" + "stateMetaInfo=" + stateMetaInfo + ", backingMap=" + backingMap + ", internalMapCopySerializer=" + internalMapCopySerializer + '}';
	}

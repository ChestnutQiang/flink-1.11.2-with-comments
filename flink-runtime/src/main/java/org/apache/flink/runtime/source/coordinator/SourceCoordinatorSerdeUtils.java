...
public class SourceCoordinatorSerdeUtils {
	 ...
	 */
	static <SplitT> void writeAssignmentsByCheckpointId(Map<Long, Map<Integer, LinkedHashSet<SplitT>>> assignmentByCheckpointIds,
		SimpleVersionedSerializer<SplitT> splitSerializer, DataOutputStream out) throws IOException {
	 ...
	 */
	static <SplitT> Map<Long, Map<Integer, LinkedHashSet<SplitT>>> readAssignmentsByCheckpointId(DataInputStream in,

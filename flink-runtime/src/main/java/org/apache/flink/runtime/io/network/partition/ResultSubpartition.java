 ...
 * // TODO_MA 注释： 是 ResultPartition 的一个子分区。每个 ResultPartition 包含多个 ResultSubpartition，
 * // TODO_MA 注释： 其数目要由下游消费 Task 数和 DistributionPattern 来决定
 */
public abstract class ResultSubpartition {
	...
	// TODO_MA 注释： 从属于哪个 ResultPartition

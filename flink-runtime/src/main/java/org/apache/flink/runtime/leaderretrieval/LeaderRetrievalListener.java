...
/**
 * // TODO_MA 注释： 希望通过{@link LeaderRetrievalService} 通知有关更换领导者的类必须实现此接口。
 * Classes which want to be notified about a changing leader by the {@link LeaderRetrievalService} have to implement this interface.
 */

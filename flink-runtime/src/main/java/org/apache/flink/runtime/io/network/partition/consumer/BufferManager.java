...
/**
 * // TODO_MA 注释： {@link InputChannel}用于请求/回收*专用或浮动缓冲区的通用缓冲区管理器。
...
public class BufferManager implements BufferListener, BufferRecycler {
	...
	/**
	 * // TODO_MA 注释： 该队列中，放置的是： NetworkBuffer（封装了 MemorySegment）

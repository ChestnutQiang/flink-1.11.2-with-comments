...
/**
 * // TODO_MA 注释： 共同位置组是 JobVertices 的组，其中一个顶点的i个子任务必须在与它的i
 * // TODO_MA 注释： 个子任务相同的 TaskManager 上执行同一组中的所有其他JobVertices。
 ...
 *
 * // TODO_MA 注释： 例如，共置位组用于确保将迭代头和迭代尾的第i个子任务调度到同一TaskManager。

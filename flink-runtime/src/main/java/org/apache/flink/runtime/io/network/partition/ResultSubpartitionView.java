...
/**
 * // TODO_MA 注释： 写入的 Buffer 最终被保存在 ResultSubpartition 中维护的一个队列中，
 * // TODO_MA 注释： 如果需要消费这些 Buffer，就需要依赖 ResultSubpartitionView。
 * // TODO_MA 注释： 当需要消费一个 ResultSubpartition 的结果时，
 * // TODO_MA 注释： 需要创建一个 ResultSubpartitionView 对象，并关联到 ResultSubpartition 中；
 * // TODO_MA 注释： 当数据可以被消费时，会通过对应的回调接口告知 ResultSubpartitionView
 *
...
public interface ResultSubpartitionView {
	...
	// TODO_MA 注释： 通知 ResultSubpartition 的数据可供消费

...
public class NestedMapsStateTable<K, N, S> extends StateTable<K, N, S> {
	...
	public NestedMapsStateTableSnapshot<K, N, S> stateSnapshot() {
		return new NestedMapsStateTableSnapshot<>(this, getKeySerializer(), getNamespaceSerializer(), getStateSerializer(),
	...
	static class NestedMapsStateTableSnapshot<K, N, S> extends AbstractStateTableSnapshot<K, N, S> {
		...
		NestedMapsStateTableSnapshot(NestedMapsStateTable<K, N, S> owningTable, TypeSerializer<K> localKeySerializer,
			TypeSerializer<N> localNamespaceSerializer, TypeSerializer<S> localStateSerializer,

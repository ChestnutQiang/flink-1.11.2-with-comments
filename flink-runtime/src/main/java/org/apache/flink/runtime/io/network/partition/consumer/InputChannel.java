 ...
 * </ol>
 * // TODO_MA 注释： 每个 InputGate 会包含一个以上的 InputChannel，和 ExecutionGraph 中的 ExecutionEdge 一一对应，
 * // TODO_MA 注释： 也和 ResultSubpartition 一对一地相连，即一个 InputChannel 接收一个 ResultSubpartition 的输出
 */
public abstract class InputChannel {
	...
	/*************************************************
	 *
	 *  注释： 消费的目标 ResultPartitionID
	 */
	protected final ResultPartitionID partitionId;

	/*************************************************
	 *
	 *  注释： 属于哪一个 SingleInputGate
	 */
	...
	protected InputChannel(SingleInputGate inputGate, int channelIndex, ResultPartitionID partitionId, int initialBackoff, int maxBackoff,
		Counter numBytesIn, Counter numBuffersIn) {
	...
	/**
	 * // TODO_MA 注释： 回调函数，告知 InputGate 当前 channel 有数据
	 ...
	 * {@link BufferAndAvailability#moreAvailable()} when polling the next buffer from this channel.
	 *
	 ...
	 * That ensures that the parent InputGate will always be notified about the exception.
	 */

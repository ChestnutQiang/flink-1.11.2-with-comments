...
@Public class StreamExecutionEnvironment(javaEnv: JavaEnv) {
   ...
   */
  @PublicEvolving def getJobListeners = javaEnv.getJobListeners
   ...
   *
   */
  @PublicEvolving def disableOperatorChaining(): StreamExecutionEnvironment = {
   ...
   */
  @deprecated
  @PublicEvolving def enableCheckpointing(interval: Long, mode: CheckpointingMode, force: Boolean): StreamExecutionEnvironment = {
   ...
   */
  @deprecated
  @PublicEvolving def enableCheckpointing(): StreamExecutionEnvironment = {
   ...
   */
  @PublicEvolving def setStateBackend(backend: StateBackend): StreamExecutionEnvironment = {
   ...
   */
  @Deprecated
  @PublicEvolving def setStateBackend(backend: AbstractStateBackend): StreamExecutionEnvironment = {
   ...
   */
  @PublicEvolving def getStateBackend: StateBackend = javaEnv.getStateBackend()
   ...
   */
  @PublicEvolving def setRestartStrategy(restartStrategyConfiguration: RestartStrategyConfiguration): Unit = {
   ...
   */
  @PublicEvolving def getRestartStrategy: RestartStrategyConfiguration = {
   ...
   */
  @PublicEvolving def setNumberOfExecutionRetries(numRetries: Int): Unit = {
   ...
   *            FixedDelayRestartStrategyConfiguration contains the number of execution retries.
   */
  @PublicEvolving def getNumberOfExecutionRetries = javaEnv.getNumberOfExecutionRetries
   ...
   */
  @PublicEvolving def setStreamTimeCharacteristic(characteristic: TimeCharacteristic): Unit = {
   ...
   */
  @PublicEvolving def getStreamTimeCharacteristic = javaEnv.getStreamTimeCharacteristic()
   ...
   */
  @PublicEvolving def configure(configuration: ReadableConfig, classLoader: ClassLoader): Unit = {
   ...
   */
  def readFile[T: TypeInformation](inputFormat: FileInputFormat[T], filePath: String): DataStream[T] = asScalaStream(
   ...
   *
   */
  @Deprecated def readFileStream(StreamPath: String, intervalMillis: Long = 100,
    watchType: FileMonitoringFunction.WatchType = FileMonitoringFunction.WatchType.ONLY_NEW_FILES): DataStream[String] = asScalaStream(
   ...
   */
  @PublicEvolving
  @Deprecated def readFile[T: TypeInformation](inputFormat: FileInputFormat[T], filePath: String, watchType: FileProcessingMode, interval: Long,
   ...
   * @return The data stream that represents the data read from the given file
   */
  @PublicEvolving def readFile[T: TypeInformation](inputFormat: FileInputFormat[T], filePath: String, watchType: FileProcessingMode,
   ...
   */
  @PublicEvolving def socketTextStream(hostname: String, port: Int, delimiter: Char = '\n',
    maxRetry: Long = 0): DataStream[String] = asScalaStream(javaEnv.socketTextStream(hostname, port))
   ...
   */
  @PublicEvolving def createInput[T: TypeInformation](inputFormat: InputFormat[T, _]): DataStream[T] = if (inputFormat
    .isInstanceOf[ResultTypeQueryable[_]]) {
   ...
   */
  @Experimental def fromSource[T: TypeInformation](source: Source[T, _ <: SourceSplit, _], watermarkStrategy: WatermarkStrategy[T],
   ...
   */
  @PublicEvolving def registerJobListener(jobListener: JobListener): Unit = {
   ...
   */
  @PublicEvolving def executeAsync(): JobClient = javaEnv.executeAsync()
   ...
   *         completed on submission succeeded.
   */
  @PublicEvolving def executeAsync(jobName: String): JobClient = javaEnv.executeAsync(jobName)
   ...
   */
  @Internal def getStreamGraph = javaEnv.getStreamGraph
   ...
   * @return The StreamGraph representing the transformations
   */
  @Internal def getStreamGraph(jobName: String) = javaEnv.getStreamGraph(jobName)
   ...
   * @return The StreamGraph representing the transformations
   */
  @Internal def getStreamGraph(jobName: String, clearTransformations: Boolean) = javaEnv.getStreamGraph(jobName, clearTransformations)
   ...
   */
  @Internal def getWrappedStreamExecutionEnvironment = javaEnv
...
object StreamExecutionEnvironment {
   ...
   */
  @PublicEvolving def setDefaultLocalParallelism(parallelism: Int): Unit = JavaEnv.setDefaultLocalParallelism(parallelism)
  
  /**
   * Gets the default parallelism that will be used for the local execution environment created by
   * [[createLocalEnvironment()]].
   */
  @PublicEvolving def getDefaultLocalParallelism: Int = JavaEnv.getDefaultLocalParallelism
   ...
   */
  @PublicEvolving def createLocalEnvironmentWithWebUI(config: Configuration = null): StreamExecutionEnvironment = {
